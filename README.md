...
- [Live Demo Link](https://yodit93.github.io/todo-app-react/dist)
...
``git clone `https://github.com/yodit93/todo-app-react.git`
...
Feel free to check the [issues page](https://github.com/yodit93/todo-app-react/issues).
